...
if __name__ == '__main__':
    ...
    data_pic = shred.Data_shredder(directory="project/images2/", output_directory="project/output1/", num_of_duplication=1, net_input_size=[30, 25, 25])
    ...
    x, y = data_pic.generate_data(tiles_per_dim=[2], save_crops=1, add_random_crops=0)
